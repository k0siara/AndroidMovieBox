...
abstract class BaseFullScreenDialogFragment<STATE : ViewState, VM : BaseViewModel<STATE>, VDB : ViewDataBinding>(
    ...
    override fun onCreateView(
        ...
        return RelativeLayout(requireContext()).apply {
            ...
            loader = LottieAnimationView(requireContext()).apply {
                ...
                setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.dark_brown))
